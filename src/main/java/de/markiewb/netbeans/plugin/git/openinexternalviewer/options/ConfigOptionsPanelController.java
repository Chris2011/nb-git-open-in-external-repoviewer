...
@OptionsPanelController.SubRegistration(
        ...
        keywordsCategory = "Team/Config"
)
@org.openide.util.NbBundle.Messages({"AdvancedOption_DisplayName_Config=Open URL of GIT repository hoster", "AdvancedOption_Keywords_Config=url,git,repo,repository"})
