...
//        new Options().resetToDefault();
    ...
    public static String getDefaultConfig() {
        return "$.global.strategies=github,gitblit,bitbucket,googlecode,gitlab,gitweb\n"
                ...
                + "bitbucket.target.show_file.url.0=https://bitbucket.org/<repo>/src/<branch>/<fullfilepath>?at=<branch>&fileviewer=file-view-default#<filename>-<linenumber|1based>\n"
                + "bitbucket.target.show_file.url.1=https://bitbucket.org/<repo>/src/<branch>/<fullfilepath>?at=<branch>&fileviewer=file-view-default#<filename>-<linenumber|1based>\n"
